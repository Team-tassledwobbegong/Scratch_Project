...
const postCreator = ({ albums, albumIndex }) => {
  ...
  const handlePostSubmission = async () => {
    ...
    console.log(`albumImage: ${image}, albumID: ${albumID}, postBody: ${document.getElementById('textID').value}`);
  ...
  return (
    <>
      <div>
        ...
        <textarea id="textID" className="textarea" rows="10" cols="50" spellCheck="true" required='true' autoComplete='true' placeholder='Enter Your Review Here'></textarea>
        <p className="buttonRow"><Link to='/'><Button className="postReviewButton" onClick={() => handlePostSubmission()}>Post Review</Button></Link></p>
        </Container>
      </div>
